...
class DebugView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        for _btn in (self.refresh_btn, self.copy_btn, self.open_folder_btn, self.send_btn):
            _btn.setProperty("toolbar", "true")
        self.delete_btn.setProperty("toolbar-danger", "true")
        ...
        for _btn in (
            self.runtime_refresh_btn,
            self.runtime_clear_btn,
            self.runtime_copy_btn,
            self.runtime_save_btn,
            self.runtime_open_folder_btn,
        ):
            _btn.setProperty("toolbar", "true")
        ...
        # Let the theme handle styling — just set the monospace font
        self.crash_log_viewer.setFontPointSize(10)
        self.runtime_log_viewer.setFontPointSize(10)
