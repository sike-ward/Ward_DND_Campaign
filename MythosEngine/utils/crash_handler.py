...
from MythosEngine.utils.utils import TracebackHighlighter
...
class CrashHandler:
    ...
    def _show_gui_error_dialog(error_msg, log_file):
        ...
        dlg.setWindowTitle("MythosEngine – Crash Handler")
        ...
        header_title = QLabel("<span style='font-size:22pt;font-weight:bold;'>MythosEngine Crash Handler</span>")
        ...
        summary = QLabel(
            "<b>Oops!</b> MythosEngine encountered a critical error and must close.<br>"
