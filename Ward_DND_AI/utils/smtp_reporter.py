"""
SMTPReporter — Async email crash reporting for WardAI.
...
Usage:
    from Ward_DND_AI.utils.smtp_reporter import reporter
...
_logger = logging.getLogger("ward_dnd_smtp_reporter")
...
class SMTPReporter:
    ...
    def _send_email_blocking(self, error_msg: str, log_file: str, exc_type: str) -> None:
        ...
        """
        try:
            subject = f"[Ward DND AI Crash] {exc_type} — {self.app_env}"
